...
function Room({ room }) {
    ...
    return <VStack w={"400px"} rounded={'lg'} shadow={'lg'} backgroundColor={bkgColor}>
        <HStack width={"100%"} rounded={'lg'} justifyContent={"center"} p={1} fontWeight={"bold"} backgroundColor={vcColor}
                color={"white"}>
